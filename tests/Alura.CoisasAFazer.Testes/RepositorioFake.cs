...
namespace Alura.CoisasAFazer.Testes
{
    class RepositorioFake : IRepositorioTarefas
    {
        ...
        public void IncluirTarefas(params Tarefa[] tarefas) => tarefas.ToList().ForEach(t => this.lista.Add(t));
        ...
        public IEnumerable<Tarefa> ObtemTarefas(Func<Tarefa, bool> filtro) => this.lista.Where(filtro);
    }
}
